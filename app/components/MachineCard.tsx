...
export default function MachineCard({
  ...
  return (
    <div
      className="bg-white border border-gray-200 rounded-xl overflow-hidden cursor-default h-full"
      style={{
    ...
    >
      <div className="relative h-48 bg-gray-100 overflow-hidden">
        ...
        {badge && (
          <div className="absolute top-3 right-3 bg-navy text-white text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full">
            {badge}
          </div>
        )}
      </div>
